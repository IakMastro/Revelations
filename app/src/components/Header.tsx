    ...
    return (
      <nav className={"relative w-full flex flex-wrap items-center justify-between py-3 bg-gray-900 text-gray-200" +
        ...
        <div className={"container-fluid w-full flex flex-wrap items-center justify-between px-6"}>
          <button
            className={"navbar-toggler text-gray-200 border-0 hover:shadow:none hover:no-underline py-2 px-2.5" +
              " bg-transparent focus:outline-none focus:ring-0 focus:shadow-none focus:no-underline"}
            type={"button"}
          ...
          <div className={"collapse navbar-collapse flex-grow items-center"} id={"navbarSupportedContent"}>
            ...
            <ul className={"navbar-nav flex flex-col pl-0 list-style-none mr-auto"}>
              <li className={"nav-item p-2"}>
                <a className={"nav-link text-white p-0"} href={"/"}>Home</a>
              </li>
              <li className={"nav-item p-2"}>
                <a className={"nav-link text-white p-0"} href={"/images"}>Images</a>
              </li>
              <li className={"nav-item p-2"}>
